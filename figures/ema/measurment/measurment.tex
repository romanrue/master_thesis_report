...
\begin{forest}
  ...
  [MT, name=mt,
   ...
   minimum width=1cm
    ...
    no edge,
    draw=WesMixL8qual6,
    label={[label distance=1.22em, sbox]90:\imlabel{\plotspath/plot_impulse}}
  ...
  \draw[thick, -{Latex[]}, to path={-| (\tikztotarget)}] (extr) edge ([yshift=2.56cm]mt.center)
    node [midway,above,sbox, xshift=8em, yshift=15em] {\imlabel{\plotspath/plot_impulse}};
  \draw[thick, -{Latex[]}, to path={-| (\tikztotarget)},] (exadc) edge[decorate] (cpu);
  \node at ([yshift=-2em]mt.south) [anchor=south] {\includegraphics[width=3.2cm]{\imgpath/mt_scheme.pdf}};
