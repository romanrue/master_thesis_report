...
\input{preamble}
\input{\imgpath/presets/colors/colors} % imports predefined colors
...
\include{\texpath/state_of_art}
\include{\texpath/signal_conditioning}
% \include{\texpath/analog_circuits}
\include{\texpath/dac_software}
\include{\texpath/test_setups}
% \include{\texpath/sample_chapter}

\include{\texpath/results}
\include{\texpath/conclusion}
